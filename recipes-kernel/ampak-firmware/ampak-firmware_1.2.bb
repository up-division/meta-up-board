...
do_install () {
   ...
   install -m 755 ${UNPACKDIR}/brcmfmac-ampak.conf ${D}${base_libdir}/modprobe.d/

   install -d ${D}${base_libdir}/firmware/ampak/brcm
   install -m 755 ${UNPACKDIR}/brcmfmac43430-sdio.bin ${D}${base_libdir}/firmware/ampak/brcm/
   install -m 755 ${UNPACKDIR}/brcmfmac43430-sdio.txt ${D}${base_libdir}/firmware/ampak/brcm/
   install -m 755 ${UNPACKDIR}/brcmfmac43455-sdio.bin ${D}${base_libdir}/firmware/ampak/brcm/
   install -m 755 ${UNPACKDIR}/brcmfmac43455-sdio.txt ${D}${base_libdir}/firmware/ampak/brcm/

   install -d ${D}${sysconfdir}/firmware/
   install -m 755 ${UNPACKDIR}/BCM43430A1.hcd ${D}${sysconfdir}/firmware/
   install -m 755 ${UNPACKDIR}/BCM4345C0.hcd ${D}${sysconfdir}/firmware/
